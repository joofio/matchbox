...
/**
 * Copy of HapiWorkerContext because it is final, functional can be moved back afterwards
 * @author oliveregger
 *
 */
public final class TransformWorkerContext implements IWorkerContext, ValueSetExpander, ValueSetExpanderFactory {
  ...
  private StructureMapTransformProvider structureMapTransformProvider; 

  public TransformWorkerContext(FhirContext theCtx, IValidationSupport theValidationSupport, StructureMapTransformProvider smtp) {
    ...
    this.structureMapTransformProvider = smtp;
  }
  ...
  public StructureMap getTransform(String url) {
	  return this.structureMapTransformProvider.getMapByUrl(url);
  }

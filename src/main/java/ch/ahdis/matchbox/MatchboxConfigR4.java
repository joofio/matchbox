...
public class MatchboxConfigR4 extends BaseJavaConfigR4 {
  ...
  public IInstanceValidatorModule instanceValidatorR4() {
    // use an instance validator which incorporates the ValidationEngine from RI
    // with R5 version
    FhirInstanceValidator val = new FhirInstanceValidator(defaultProfileValidationSupport());

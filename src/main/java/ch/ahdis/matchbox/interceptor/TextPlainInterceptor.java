 ...
 *
 */
public class TextPlainInterceptor extends InterceptorAdapter {

	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TextPlainInterceptor.class);

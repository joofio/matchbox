...
ARG JAR_FILE=target/matchbox-0.8.10-SNAPSHOT.jar
...
RUN java -Xmx1G -Xms1G -cp /app.jar -Dloader.main=ch.ahdis.matchbox.util.PackageCacheInitializer org.springframework.boot.loader.PropertiesLauncher -id ch.fhir.ig.ch-epr-mhealth -v dev 
RUN rm -rf /packages
